...
export default class Checkout extends React.Component {
  ...
  // Toasts
  notify = () =>
    (this.orderToast = toast("Placing Order", {
        ...
        dynamodb.getItem(itemParams, (err, data) => {
          if (err) console.log(err, err.stack);
            ...
            this.setState({
              cart: [
                ...this.state.cart,
                { ...testItem, quantity: item.quantityInCart }
              ]
            });
              ...
              orderItems: [
                ...this.state.orderItems,
                {
                  M: {
                    ...
                    quantity: { N: item.quantityInCart.toString() }
                  }
                }
              ]
            });
            ...
            this.setState({
              ...
              tax:
                ...
                Number(this.calculateTax(department, itemTotalPrice))
            });
  ...
  renderContactDetails() {
    if (this.state.contactPanel) {
      return (
        <div>
          <div style={validEntry}>{this.state.phoneNumber}</div>
          <div style={validEntry}>{this.state.email}</div>
          <div style={{ marginLeft: "1.5rem" }}>
            <Button
              style={{
                paddingLeft: "3rem",
              ...
              snacksStyle={"secondary"}
              onClick={() => {
                this.setState({ contactPanel: false });
              }}
              type="submit"
            >
              Change
        ...
        <div>
          <ul style={{ listStyleType: "none", marginBottom: "3rem" }}>
            <CreditCard
              ...
              last4={this.state.paymentMethod.last4}
              isDefault={false}
            />
          </ul>
          <div style={{ marginLeft: "1.5rem" }}>
            <Button
              ...
              snacksStyle={"secondary"}
              onClick={() => {
                this.setState({ paymentPanel: false });
              }}
            >
              Change
            </Button>
      ...
      return (
        <div>
          <div style={validEntry}>
            {this.state.deliveryDay}, from {this.state.deliveryTime}
          </div>
          ...
          <div style={checkout} id="pageBody">
            ...
            <div style={checkoutForm}>
              ...
              <CheckoutPanel
                ...
                onValidTitle={"Delivery Time"}
                valid={this.state.timePanel}
              >
                <div>{this.renderDeliveryTime()}</div>
              </CheckoutPanel>
              <CheckoutPanel
                icon={"iconPerson"}
                title="Enter contact details"
                valid={this.state.contactPanel}
              ...
              <CheckoutPanel
                ...
                onValidTitle={"Payment"}
              >
                {this.renderPaymentMethods()}
              </CheckoutPanel>
              <CheckoutPanel
                icon={"orderReview"}
                title={this.state.cart.length + " Items"}
              >
                  ...
                  <Button
                    ...
                    disabled={
                      !(
                        ...
                        this.state.paymentPanel &&
                        this.state.contactPanel &&
                        this.state.timePanel
                      )
                    }
                  >
                    Place order
