        ...
        if (err) {
          ...
          this.setState({
            item: {
              ...
              quantity: data.Item.quantity.S,
              sale: data.Item.sale.N
            }
          });
        ...
        if (err) {
          ...
          data.Items.forEach(element => {
            let tempItem = {
              ...
              name: element.name.S,
              department: element.department.S,
      ...
      return (
        <div>
          ...
          <div id="pageBody">
            ...
            >
              <h1 style={{ marginTop: "0", fontSize: "2em" }}>
                {this.state.item.name}
              </h1>
              <p style={{ marginTop: "3%", color: "grey", fontSize: "1.4em" }}>
        ...
        <div>
          ...
          <div id="pageBody" style={{ minHeight: window.innerHeight - 245 }}>
            ...
            >
              ...
              <p style={{ marginTop: "5%", color: "grey", fontSize: "1.4em" }}>
                {this.state.item.quantity}
              </p>
              {this.renderPrice()}
              {this.renderButtonBar()}
