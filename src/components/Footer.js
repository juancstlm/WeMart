    ...
    return (
      <div>
        <Modal
          ...
          onHide={this.handleCloseContactUsModal}
        >
          <Modal.Header>
            <div style={{ float: "right" }}>
              <Icon
                name="x"
                onClick={this.handleCloseContactUsModal}
                style={close}
              />
            </div>
          ...
          <Modal.Body>
            ...
            >
              <input
                type="hidden"
                name="_next"
                value="https://wemart-133.herokuapp.com/home"
              />
              ...
              >
                <Button
                  type="submit"
                  className="primary"
                  style={{ height: "40px", width: "100%", display: "inital" }}
                >
                  Submit
                </Button>
              </div>
        ...
        <div style={footerStyle}>
          <div>
            <div style={footerLinksContainer}>
              ...
              <a href={'/#'} onClick={(e, props) => {e.preventDefault(); this.handleShowContactUsModal()}} style={Links}>
                Contact Us
              </a>
              <Link to={"./locations"} style={Links}>
                Locations
              </Link>
            ...
            <div style={Spacing}>
              ...
              <a href={"https://github.com/timroesner/WeMart"} style={Links}>
                WeMart
              </a>{" "}
              Inc.
            </div>
