...
const modalButton_Accept = {
  margin: "1.8rem 0 1rem 1rem",
  paddingRight: "3rem",
  paddingLeft: "3rem"
};
const modalButton_Cancel = {
...
class AccountSettings extends React.Component {
  constructor(props, context) {
    ...
    this.handleShowPersonalInfoModal = this.handleShowPersonalInfoModal.bind(
      this
    );
  ...
  handleEmailChange = model => {
    ...
    cognitoUser.changePassword(model.password, model.password, (err, data) => {
      if (err) {
        ...
        this.state.cognitoUser.updateAttributes(attribues, (err, data) => {
          if (err) console.log(err, err.stack);
          else {
            console.log(data);
            console.log(model);
      ...
      <div>
        <Modal show={this.state.editAddressModal} onHide={this.handleClose}>
          ...
          <Modal.Body>
            <Form
              onSubmit={model => {
                this.handleUpdateAddress(model);
              }}
            >
              <div>
                <TextField
              ...
              <Button
                style={modalButton_Cancel}
                snacksStyle="secondary"
                onClick={this.handleClose}
              >
                Cancel
              </Button>
              <Button style={modalButton_Accept} type="submit">
                Accept
              </Button>
            </Form>
          </Modal.Body>
            ...
            <Form onSubmit={this.handlePasswordChange}>
              <div style={{ marginBottom: "1rem" }}>
                <TextField
                  ...
                  required
                  onChange={model => {
                    this.setState({ passwordInput: model.target.value });
                  }}
                />
              </div>
              <div style={{ marginBottom: "1rem" }}>
                <TextField
                  ...
                  validations={{
                    isLength: { min: 6 },
                    equals: this.state.passwordInput
                  }}
            ...
            <Form onSubmit={this.handleEmailChange}>
              <div style={{ marginBottom: "1rem" }}>
                <TextField
                  ...
                  required
                  onChange={model => {
                    this.setState({ emailInput: model.target.value });
                  }}
              ...
              <div>
                ...
                <Button type="submit" style={modalButton_Accept}>
                  Accept
                </Button>
              </div>
            </Form>
      ...
      <div>
        <Modal show={this.state.newCardModal} onHide={this.handleClose}>
          ...
          <Modal.Footer>
            ...
            <Button
              style={modalButton_Accept}
              elementAttributes={{ form: "newcard" }}
              type="submit"
            >
              Add Card
            </Button>
  ...
  renderv2() {
    if (this.state.isLoggedIn) {
        ...
        <Row maxColumns={11} style={{ maxWidth: "109.2rem" }}>
          <Column sizes={{ sm: 6, md: 5, lg: 8, xl: 8 }}>
              ...
              content={
                <div>
                  <Line
                    ...
                    onChange={this.handleShowEmailModal}
                  />
                  <Line
                    title="Password"
                    value={this.state.user.password}
                    onChange={this.handleShowPasswordModal}
                  />
                </div>
              }
            />
              ...
              content={
                <div>
                  <Line
                    ...
                    onChange={this.handleShowPersonalInfoModal}
                  />
                  <Line
                    title="Last Name"
            ...
            <ProfilePanel
              ...
              content={<div>{this.renderAddress()}</div>}
            />
          </Column>
          <Column sizes={{ sm: 6, md: 3, lg: 3, xl: 3 }}>
            ...
            <div style={{ textAlign: "center" }}>
              <Button
                style={{ margin: "1.5rem auto", width: "85%" }}
      ...
      return (
        <ProfilePanel>
          <div style={noSession}>
            <h2>You must be logged in to view account settings.</h2>
            <h4>
