      ...
      cognitoUser.getUserAttributes(function(err, result) {
        ...
        result.forEach(attribute => {
          if (attribute.Name === "email") {
            self.setState({
              user: { ...self.state.user, email: attribute.Value }
            }); // set the email
            self.setState({
              user: { ...self.state.user, userId: attribute.Value }
            }); //set the userId
          }
        });
        self.getUserDetails();
          ...
          <div style={history}>
            <div style={panel}>
              <div style={noItems}>
                ...
                <h1>No Items</h1>
                <h4>
                  Items that you order will show up here, so that you can
                  quickly find your items again
                </h4>
              </div>
              <div
                style={{ margin: "3rem auto 2rem auto", textAlign: "center" }}
              >
                <Button
                  size="large"
                  onClick={() => {
        ...
        <div style={history}>
          <div style={panel}>
            <div style={noItems}>
              ...
              <h1>No Items</h1>
              <h4>
                Items that you order will show up here, so that you can quickly
                find your items again
              </h4>
            </div>
